...
exports.deletePokemon = exports.getAllPokemon = exports.createPokemon = void 0;
...
const getAllPokemon = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const pokemons = yield pokemonService.findAllPokemon();
        res.status(200).json();
    }
    catch (error) {
...
const deletePokemon = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.body;
        yield pokemonService.deletePokemon(id);
        res.status(200).json();
    }
    catch (error) {
